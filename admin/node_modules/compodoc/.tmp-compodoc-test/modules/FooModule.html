                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                ...
                                <li class="link">
                                    <a href="./modules/FooModule.html"  class="active" >FooModule</a>
                                </li>
                        </ul>
                    </li>
...
<div class="text-center">
    <object id="demo-svg" type="image/svg+xml" data="modules/FooModule/dependencies.svg" style="width: 100%; height: 250px;">
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>test/src/sample-files/foo.module.ts</code>
        </p>
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                    <a href="./modules/FomsModule.html" >FomsModule</a>
                            </li>
                    </ul>
                </div>
                <div class="col-sm-3">
    ...
    <div class="tab-pane fade tab-source-code" id="source">
        <pre><code class="hljs javascript">import { NgModule, BrowserModule } from &#x27;@angular/core&#x27;;
