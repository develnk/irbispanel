                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                ...
                                <li class="link">
                                    <a href="./modules/BarModule.html"  class="active" >BarModule</a>
                                </li>
                                <li class="link">
...
<div class="text-center">
    <object id="demo-svg" type="image/svg+xml" data="modules/BarModule/dependencies.svg" style="width: 100%; height: 250px;">
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>test/src/sample-files/bar.module.ts</code>
        </p>
