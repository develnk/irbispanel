                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                ...
                                <li class="link">
                                    <a href="./modules/DeepModule.html"  class="active" >DeepModule</a>
                                </li>
                                <li class="link">
...
<div class="text-center">
    <object id="demo-svg" type="image/svg+xml" data="modules/DeepModule/dependencies.svg" style="width: 100%; height: 250px;">
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>test/src/sample-files/deep.module.ts</code>
        </p>
        ...
        <div class="container-fluid module">
            <div class="row">
                <div class="col-sm-3">
                    <h3>Imports<a href="https://angular.io/docs/ts/latest/api/core/index/NgModule-interface.html#!#imports-anchor" target="_blank"><span class="fa fa-info-circle"></a></h3>
                    <ul class="list-group">
                            <li class="list-group-item">
                                    RouterModule.forRoot(args)
                            </li>
                            <li class="list-group-item">
                                    <a href="./modules/StoreModule.provideStore(args).html" >StoreModule.provideStore(args)</a>
                            </li>
                            <li class="list-group-item">
                                    <a href="./modules/CoreModule.html" >CoreModule</a>
                            </li>
                            <li class="list-group-item">
                                    <a href="./modules/HomeModule.yolo1().html" >HomeModule.yolo1()</a>
                            </li>
                            <li class="list-group-item">
                                    <a href="./modules/HomeModule.bar.yolo2().html" >HomeModule.bar.yolo2()</a>
                            </li>
                            <li class="list-group-item">
                                    <a href="./modules/HomeModule.foo.bar.yolo3(args).html" >HomeModule.foo.bar.yolo3(args)</a>
                            </li>
                    </ul>
                </div>
            </div>
