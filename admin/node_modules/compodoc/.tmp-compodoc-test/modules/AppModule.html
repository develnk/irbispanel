...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>test/src/sample-files/app.module.ts</code>
        </p>
        ...
        <div class="container-fluid module">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <h3>Providers<a href="https://angular.io/docs/ts/latest/api/core/index/NgModule-interface.html#!#providers-anchor" target="_blank"><span class="fa fa-info-circle"></a></h3>
                    <ul class="list-group">
                            <li class="list-group-item">
                                <a href="./injectables/FooService.html" >FooService</a>
                            </li>
