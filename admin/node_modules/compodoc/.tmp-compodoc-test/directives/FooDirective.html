                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                ...
                                <li class="link">
                                    <a href="./directives/FooDirective.html"  class="active" >FooDirective</a>
                                </li>
                        </ul>
                    </li>
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>test/src/sample-files/foo.directive.ts</code>
        </p>

    </div>
    <div class="tab-pane fade tab-source-code" id="source">
        <pre><code class="hljs javascript">import { Directive } from &#x27;@angular2/core&#x27;;
