                ...
                <ul class="list">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                <li class="link">
                                    <a href="./directives/BarDirective.html"  class="active" >BarDirective</a>
                                </li>
                                <li class="link">
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>test/src/sample-files/bar.directive.ts</code>
        </p>

    </div>
    <div class="tab-pane fade tab-source-code" id="source">
        <pre><code class="hljs javascript">import { Directive } from &#x27;@angular/core&#x27;;

@Directive({ selector: &#x27;[app-bar]&#x27; })
export class BarDirective { }</code></pre>
    </div>
</div>
