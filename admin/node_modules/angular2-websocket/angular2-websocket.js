...
var $WebSocket = (function () {
     ...
     * @returns {boolean}
     */
    $WebSocket.prototype.send4Direct = function (data) {
        var self = this;
     ...
     * @returns {Promise<any>}
     */
    $WebSocket.prototype.send4Promise = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (_this.send4Direct(data)) {
                return resolve();
            }
            else {
     ...
     */
    $WebSocket.prototype.send4Observable = function (data) {
        var _this = this;
     ...
     * @returns {any}
     */
    $WebSocket.prototype.send = function (data, mode) {
